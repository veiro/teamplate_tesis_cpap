...
\addbibresource{bibliografia/biblio.bib} % Se coloca una línea por archivo .bib.
...
\begin{document}
  ...
  \subtitle{Subtitulo de la tesis}
  ...
  %
  \director{Prof.}{Nombre}{Apellido}{Dr}
  ...
  \directoracademico{Prof.}{Nombre}{Apellido}{Dr}
  %
  ...
  %
  \graduatename{Nombre del titulo}
 ...
 % \thirduniversity{Universidad YYYYY} % Se agrega el nombre de otra universidad. Comentar esta linea si no es necesaria.
  ...
  %
  \date{01}{05}{2019} % Fecha del documento: día/mes/año
